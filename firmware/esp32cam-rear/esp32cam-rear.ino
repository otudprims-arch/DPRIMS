// DPRIMS - ESP32-CAM Rear (Standalone MJPEG Stream)
// Board: AI Thinker ESP32-CAM
// IP: 192.168.1.102 (http://192.168.1.102/stream)
...
void handleClient(WiFiClient& client) {
  ...
  if (!req.startsWith("GET /stream")) {
    ...
    client.println("<h1>DPRIMS Rear CAM</h1>");
...
void setup() {
  ...
  Serial.println("Rear CAM stream: http://192.168.1.102/stream");
}
